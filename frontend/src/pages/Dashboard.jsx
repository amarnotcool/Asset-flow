  ...
  return (
    <div ref={dashboardRef} className="flex flex-col">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-text-primary m-0">Today's Overview</h1>
          <p className="text-sm text-text-secondary mt-1 m-0">Real-time operational snapshot across all assets and resources</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
        <div className="card p-5 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-text-primary m-0">{availableCount}</h3>
        </div>
        ...
        <div className="card p-5 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-text-primary m-0">{allocatedCount}</h3>
        </div>
        ...
        <div className="card p-5 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-text-primary m-0">{maintenanceCount}</h3>
        </div>
        ...
        <div className="card p-5 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-text-primary m-0">{activeBookingsCount}</h3>
        </div>
        ...
        <div className="card p-5 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-text-primary m-0">{pendingTransfersCount}</h3>
        </div>
        ...
        <div className="card p-5 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-text-primary m-0">{upcomingReturnsCount}</h3>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <button
          ...
          className="btn btn-outline flex-1 min-w-[160px] py-3 text-base"
        >
      ...
      <div className="card p-6">
        <h2 className="text-lg font-semibold border-b border-border-color pb-3 m-0">Recent Activity Feed</h2>
        <ul className="list-none flex flex-col gap-4 mt-4 p-0">
          <li className="flex items-start gap-4">
            <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 bg-[#e0f2fe] text-accent-primary">
              <Package size={16} />
            </div>
            <div>
              <p className="text-sm text-text-primary mb-1 m-0">
